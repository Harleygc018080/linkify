...
export const siteConfig = {
  name: "Linkify - one page, many links.",
  description: "Linkify help you to Create a personalized page to showcase all your social media profiles in one place.",
    ...
    <section className="bg-[#FCF8F1] bg-opacity-30 py-10 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    <p className="text-base font-semibold tracking-wider text-blue-600 uppercase">Make your online presence easier to manage!</p>
                    <h1 className="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-[5.3rem]">Organize and optimize your links with Linkify</h1>
